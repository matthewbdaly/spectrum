  ...
  render() {
    return (
      <div>
        ...
        <p>The <code>warm</code> theme turns it orange</p>
        <Button theme="warm">Button with the warm theme</Button>
        ...
        <Button theme="warm" inverse="true">Button with the inverse warm theme</Button>
        ...
        <Button theme="warm" inverse="true">
          <i className="fas fa-sliders-h"></i>
        </Button>
        ...
        <Button block="true" theme="warm">Button with the warm theme</Button>
        ...
        <Button block="true" theme="warm" inverse="true">Button with the inverse warm theme</Button>
        ...
        <Button rounded="true" theme="warm">Button with the warm theme</Button>
        ...
        <Button rounded="true" theme="warm" inverse="true">Button with the inverse warm theme</Button>
